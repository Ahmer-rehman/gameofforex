      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-7 col-lg-8">
            ...
            <h5>Welcome to Game of forex!</h5>
              <h1>
              Where <span>Learning</span>Meets Profits!
              </h1>
              <p>
              Game of Forex is more than just a platform.Game of Forex creates an environment learning become a thrilling journey of discovery and profit.
             </p>
